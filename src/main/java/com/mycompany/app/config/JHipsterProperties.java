...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "notrans@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "notrans API";

        private String description = "notrans API documentation";
